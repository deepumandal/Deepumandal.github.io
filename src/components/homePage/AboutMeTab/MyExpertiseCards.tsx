        ...
        return (
          <div className="flex gap-2 border w-fit laptop:w-[48%] m-auto tabView:m-0 tabView:w-space-avialable  p-4 items-start rounded-xl">
            ...
            <div className="flex flex-col w-fit">
              <h1 className="font-inter font-semibold text-[18px] tabView:text-[20px] max-w-52">
                {expertiseCard.title}
              </h1>
              <p className="font-inter text-[12px] tabView:text-[14px] max-w-60 tabView:max-w-space-avialable">
                {expertiseCard.shortDescription}
              </p>
            </div>
            <p className="tabView:whitespace-nowrap">know more</p>
          </div>
        );
      })}
    </div>
