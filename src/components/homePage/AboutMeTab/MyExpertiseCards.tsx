        ...
        return (
          <div className="flex gap-2 border w-fit laptop:w-[48%] m-auto tabView:m-0 tabView:w-space-avialable  p-4 items-start rounded-xl">
            ...
            <div className="flex flex-col w-fit">
              <h1 className="font-inter font-semibold text-heading-l dark:text-heading-d text-[18px] tabView:text-[20px] max-w-52">
                {expertiseCard.title}
              </h1>
            ...
            <p className="tabView:whitespace-nowrap text-link-l dark:text-link-d">know more</p>
          </div>
        );
      })}
    </div>
