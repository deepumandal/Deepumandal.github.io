...
const TabMenu: React.FC = () => {
  ...
  return (
    <div className="hidden tabView:flex tabView:flex-row-reverse laptop:h-fit laptop:flex-col laptop:items-center tabView: items-center tabView:gap-4  tabView:mb-4 p-2">
      <ThemeMode />
      <div className="bg-white tabView:p-3 tabView:flex tabView:gap-4 laptop:flex laptop:flex-col rounded-2xl laptop:my-10 laptop:gap-5 laptop:py-8">
        {" "}
        {tabs.map((tab) => {
          return (
            <div className="bg-[#F9F8FA] p-3 cursor-pointer rounded-xl border ">
