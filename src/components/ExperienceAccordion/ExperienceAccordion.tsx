...
const ExperienceAccordion: React.FC<ExperienceAccordionProps> = ({
    ...
    return (
        <Stack margin={"50px"} id="experience" w={{
            base: "90%", sm: "100%"
        }}>
                        ...
                        <AccordionItem key={section.title}>
                            {({ isExpanded }) => (
                                <>
                                    ...
                                    <AccordionPanel padding={"1rem"} display={"flex"} flexDirection={"column"} gap={"1rem"} margin={"auto"} id="accordianpannel" backgroundColor={theme.body}>
